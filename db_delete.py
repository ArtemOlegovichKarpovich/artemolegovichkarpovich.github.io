...
db_delete_request = "DELETE FROM timetable WHERE \"group\" = \"{}\" AND \"date\" = \"{}\" AND \"pair\" = \"{}\";".format(request_arr[0], request_arr[1], request_arr[4])
...
cursor = conn.cursor()
cursor.execute(db_delete_request)
conn.commit()
